...
DECLARE
    ...
    idiomas_va varchar(50)[] := ARRAY[]::varchar(50);
...
CREATE OR REPLACE PROCEDURE CREAR_PERSONAL_INTELIGENCIA (
    ...
    segundo_nombre_va IN EMPLEADO_JEFE.segundo_nombre%TYPE, 
    primer_apellido_va IN EMPLEADO_JEFE.primer_apellido%TYPE, 
    segundo_apellido_va IN EMPLEADO_JEFE.segundo_apellido%TYPE, 
    fecha_nacimiento_va IN EMPLEADO_JEFE.fecha_nacimiento%TYPE, 
    ...
    identificacion_1_va IN identificacion_ty%TYPE, 
...
BEGIN 
   ...
   RAISE INFO 'Datos del personal de inteligencia: %', personal_inteligencia_regv ; 
...
CALL CREAR_PERSONAL_INTELIGENCIA (
    ...
    '20/20',
    'no_clasificado',
    FORMATO_ARCHIVO_A_BYTEA('crudo_contenido/images.jpg'),
    FORMATO_ARCHIVO_A_BYTEA('crudo_contenido/images.jpg'),
    FORMATO_ARCHIVO_A_BYTEA('crudo_contenido/images.jpg'),
    CREAR_TELEFONO(0212,1212321),
    CREAR_LICENCIA('021390213','Argentina'),
    CREAR_ARRAY_IDIOMAS('español','italiano','chino','portugués'), 
    CREAR_FAMILIAR(),
    CREAR_FAMILIAR(),
